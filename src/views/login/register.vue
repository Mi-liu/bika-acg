...
const rules = {
  ...
  email: [
    ...
    { pattern: /^[a-zA-Z0-9]+$/, message: '账号只能包含数字和字母', trigger: ['blur', 'change'] }
  ],
  password: [
    ...
    <div class="container relative size-full flex-center">
      <div class="w-900px bg-white rounded-lg flex p-10 items-center">
        ...
        <div class="flex-1 pt-15px ml-5 select-none">
          <el-form autocomplete="off" :rules="rules" :model="form" ref="formRef">
            ...
            <el-form-item label="密 码" prop="password">
              <el-input v-model="form.password" placeholder="不少于8位" type="password" autocomplete="new-password"
                show-password />
            </el-form-item>
            ...
            <el-form-item>
              <div class="w-full select-none flex justify-end">
                <div class="flex">
                  已有账号？<el-link type="primary" href="https://www.baidu.com" target="_blank"
                    underline="never">点击登录</el-link>
                </div>
